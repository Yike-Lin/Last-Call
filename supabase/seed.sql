...
-- Keep the third uploaded recipe image batch available when the local database is reseeded.
insert into public.recipe_assets (
  recipe_id,
  asset_type,
  storage_path,
...
-- Keep the fourth uploaded recipe image batch available when the local database is reseeded.
insert into public.recipe_assets (
  recipe_id,
  asset_type,
  storage_path,
...
-- Keep the fifth uploaded recipe image batch available when the local database is reseeded.
insert into public.recipe_assets (
  recipe_id,
  asset_type,
  storage_path,
