      ...
      <section className="grid gap-6 lg:grid-cols-[1fr_1fr]">
        <div className="panel flex flex-col gap-5 p-6">
          <div className="flex items-center justify-between gap-4">
            <div>
              <p className="text-xs uppercase tracking-wide text-[var(--muted)]">品鉴卡</p>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="panel p-4">
              <p className="text-xs uppercase tracking-wide text-[var(--muted)]">外观</p>
              <p className="mt-2 text-base font-semibold">深琥珀偏红，短饮体量，表面明亮</p>
            </div>
            <div className="panel p-4">
              <p className="text-xs uppercase tracking-wide text-[var(--muted)]">酒体</p>
              <p className="mt-2 text-base font-semibold">中等偏厚</p>
            </div>
            <div className="panel p-4">
              <p className="text-xs uppercase tracking-wide text-[var(--muted)]">适饮场景</p>
              <p className="mt-2 text-base font-semibold">餐前、慢节奏夜晚</p>
            </div>
            <div className="panel p-4">
              <p className="text-xs uppercase tracking-wide text-[var(--muted)]">方法备注</p>
            ...
            {balance.map((item) => (
              <div key={item.label} className="space-y-2">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="text-[var(--muted)]">{item.value}/5</span>
                </div>
